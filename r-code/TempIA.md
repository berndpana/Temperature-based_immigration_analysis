...
par(oma=c(5.5,3,2,2),mfrow=c(2,1),mar=c(5,5,4,5)+.1)
...
text(as.POSIXct("2013-02-01"), 0+5, "Ii=0", col = "black",cex=2) 
text(as.POSIXct("2016-05-01"), thourlyregion[[i]]$t0maxyears[1]+5, paste("T7th=",round(thourlyregion[[i]]$t0maxyears[1],digits=2),"°C",sep=""),cex=2)
}
