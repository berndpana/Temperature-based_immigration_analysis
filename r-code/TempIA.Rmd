...
title: Prediction of flight onset of *Cacopsylla melanoneura* and *C. picta*, vectors
  of the apple proliferation disease, using a temperature-based immigration analysis -
  Appendix A
...
```{r load_settings_data_libraries}
rm(list=ls(all=TRUE))
...
7\. T7n
```{r T7n for only a0,results="hide"}
############################################################################################
...
```{r tmax, DD, Ii for thourly,results="hide"}
...
```{r base plots, echo=TRUE,fig.height = 10,message=FALSE}
